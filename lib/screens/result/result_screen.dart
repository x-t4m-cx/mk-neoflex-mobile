...
class ResultScreen extends StatelessWidget {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 32),
              UiInfoRow(title: 'Итоговые деньги', value: '${state.money} руб'),
              UiInfoRow(
                title: 'Цель',
                value: 
                    '${Character.goal} руб - ${won ? "достигнута" : "не достигнута"}'
                    ),
  ...
  String _loseReason(GameState s) {
    ...
    if (s.happiness == 0) return 'Ты потерял все радости жизни';
